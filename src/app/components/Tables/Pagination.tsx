    ...
    <div className="flex justify-between items-center w-full mt-6">
      ...
      <div>
        <button
          ...
          className="flex items-center justify-center gap-2 px-4 py-2 rounded-lg border border-gray-300 bg-white text-gray-700 text-sm font-medium shadow-sm  hover:bg-gradient-to-r hover:from-blue-50 hover:to-blue-100 hover:text-blue-600 hover:border-blue-300 hover:shadow-lg hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-white disabled:hover:text-gray-700 disabled:hover:border-gray-300 disabled:hover:scale-100"
      ...
      <div className="flex items-center gap-1">
        ...
        {currentPageDisplay > 3 && totalPages > 5 && (
          <>
            <button
              ...
              className="w-10 h-10 rounded-lg text-sm font-medium flex items-center justify-center border border-gray-300 bg-white text-gray-700 shadow-sm hover:bg-gradient-to-r hover:from-blue-50 hover:to-blue-100 hover:text-blue-600 hover:border-blue-300 hover:shadow-md hover:scale-105"
            >
              1
            </button>
        ...
        {pagesAroundCurrent.map((page) => (
          <button
            ...
            className={`w-10 h-10 rounded-lg text-sm font-medium flex items-center justify-center border shadow-sm  relative ${
          ...
          >
            {page}
            {currentPageDisplay === page && (
              <div className="absolute inset-0 rounded-lg bg-white opacity-20"></div>
            )}
          </button>
        ))}
